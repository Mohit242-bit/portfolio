        ...
        <div className="max-w-5xl mx-auto space-y-8">
          {experiences.map((exp, idx) => (
            <ScrollAnimation key={idx} animation="fadeUp">
              <div className="group relative bg-gradient-to-br from-gray-900/50 to-gray-900/20 backdrop-blur-xl rounded-3xl border border-gray-800/50 p-8 sm:p-10 md:p-12 overflow-hidden hover:border-gray-700/50 transition-all duration-500">
                ...
                <div className="flex items-start gap-6 mb-8 relative z-10">
                  {/* Company Logo */}
                  <div className={`flex-shrink-0 w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-gradient-to-br ${exp.gradient} flex items-center justify-center shadow-lg group-hover:shadow-2xl transition-all duration-500`}>
                    <span className="text-3xl sm:text-4xl font-bold text-white">K</span>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <a 
                      ...
                      className="inline-block group/link mb-3 hover:text-gray-300 transition-colors"
                    >
                ...
                <div className="mb-8 relative z-10">
                  <h4 className="text-xl sm:text-2xl font-bold text-white mb-3">{exp.position}</h4>
                ...
                <div className="relative z-10">
                  <h5 className="text-sm font-bold text-white mb-3 uppercase tracking-wider">Technologies</h5>
                  <div className="flex flex-wrap gap-2">
                    {exp.tech.map((tech, i) => (
                      <span 
                        key={i}
                        className="px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-500/10 text-blue-300 text-xs sm:text-sm rounded-lg font-medium border border-blue-500/20 group-hover:border-blue-500/40 group-hover:bg-blue-500/20 transition-all duration-300"
                      >
                        {tech}
                      </span>
                    ))}
