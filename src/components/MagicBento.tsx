...
const cardData = [
  ...
  },
  {
    ...
    description: "Working with me might have challenges",
    label: "Reality Check",
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-300 max-w-xl sm:max-w-2xl mx-auto px-4">
            Explore the different services and solutions I offer to help bring your ideas to life
          </p>
        </div>
        ...
        <BentoCardGrid gridRef={gridRef}>
          {cardData.map((card, index) => {
            ...
            const isIssuesCard = card.title === "Issues You May Face";
            ...
            if (enableStars) {
              return (
                <ParticleCard
                  ...
                  onClick={isIssuesCard ? onIssuesClick : undefined}
                >
